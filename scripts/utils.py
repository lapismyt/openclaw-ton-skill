...
try:
    ...
    print(json.dumps({"error": "Missing dependency: requests", "install": "pip install requests"}))
    sys.exit(1)
...
try:
    ...
    print(json.dumps({"error": "Missing dependency: cryptography", "install": "pip install cryptography"}))
    sys.exit(1)
...
def main():
    ...
    addr_to_friendly = addr_sub.add_parser("to-friendly", help="Convert to user-friendly format")
    ...
    dec_parser.add_argument("--data", "-d", required=True, help="Encrypted data (base64)")
