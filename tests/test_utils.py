...
class TestAddressFormatting:
    ...
    def test_address_roundtrip_raw_to_friendly_to_raw(self):
        ...
        original_raw = "0:4e95324902a9671fa85343288b17ad6c45d93b2e2849166cc8f3aa1e9e0a0472"
    ...
    def test_raw_to_friendly_missing_colon(self):
        ...
        with pytest.raises(ValueError):
            raw_to_friendly("4e95324902a9671fa85343288b17ad6c45d93b2e2849166cc8f3aa1e9e0a0472")
    ...
    def test_friendly_to_raw_invalid_checksum(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            friendly_to_raw("EQBOlTJJAqaXH6hTQyiLF61sRdk7LihJFmzI86oengoEchAX")  # Changed last char
        
        assert "crc" in str(exc_info.value).lower() or "checksum" in str(exc_info.value).lower()
    
    def test_crc16_known_value(self):
        """CRC16 produces known value for test data."""
        # Test vector
        data = b"\x11\x00" + bytes.fromhex("4e95324902a9671fa85343288b17ad6c45d93b2e2849166cc8f3aa1e9e0a0472")
